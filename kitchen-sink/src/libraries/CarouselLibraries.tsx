...
export function CarouselLibraries() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <div className="flex-1 overflow-auto p-4 space-y-4">
        ...
        <Card className="overflow-hidden">
          <div className="p-4 border-b bg-gray-50">
            <h3 className="font-semibold text-gray-900">Auto Scroll Plugin</h3>
            <p className="text-xs text-gray-600">Continuous smooth scrolling</p>
          </div>
